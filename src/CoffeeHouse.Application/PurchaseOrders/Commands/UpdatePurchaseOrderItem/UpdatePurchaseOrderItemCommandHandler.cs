...
public class UpdatePurchaseOrderItemCommandHandler : IRequestHandler<UpdatePurchaseOrderItemCommand, PurchaseOrderDetailDto>
{
    ...
    public async Task<PurchaseOrderDetailDto> Handle(UpdatePurchaseOrderItemCommand request, CancellationToken cancellationToken)
    {
